...
public class useridServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       book= userDao.getUserbyid(slno);
        ...
        out.print("<input type='hidden' name='slno' value='" + book.getSlno() + "' />");
        ...
        out.print("<input type='text' name='author_name' value='" + book.getAuthor_name() + "' required />");
